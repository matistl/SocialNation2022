...
module.exports = {
	...
	run: async (client, message, args) => {
		...
		if (parseInt(Cantidad) > EconomyGet_Author.banco) return SendError('No tienes esa cantidad de\ndinero en el banco.', message)
		...
		EconomyGet_Author.banco -= parseInt(Cantidad);

		EconomyGet_Mention.banco += parseInt(Cantidad);

		await EconomyGet_Author.save(); s
